...
void create_window_main() {
  ...
  g_signal_connect(window_main.window, "delete-event",
                   G_CALLBACK(window_main_window_delete_event_cb), nullptr);
  ...
  GtkWidget *hbox_down = gtk_hbox_new(FALSE, 8);
  ...
  g_signal_connect(window_main.button_places, "clicked",
                   G_CALLBACK(window_main_button_places_clicked_cb), nullptr);
  ...
  g_signal_connect(window_main.button_info, "clicked",
                   G_CALLBACK(window_main_button_info_clicked_cb), nullptr);
  ...
  gtk_misc_set_alignment(GTK_MISC(window_main.label_cash), 1.0f, 0.5f);
  set_label_cash(1900);
  ...
  gtk_misc_set_alignment(GTK_MISC(window_main.label_bank), 1.0f, 0.5f);
  set_label_bank(0);
  ...
  gtk_misc_set_alignment(GTK_MISC(window_main.label_debt), 1.0f, 0.5f);
  set_label_debt(0);
...
void create_window_finance() {
  ...
  GtkWidget *hbox = gtk_hbox_new(FALSE, 130);
  ...
  window_finance.radiobutton_depositsome = gtk_radio_button_new_with_label(nullptr, "Deposit some");
...
void create_window_hospital() {
  ...
  GtkWidget *image = gtk_image_new_from_stock(GTK_STOCK_HELP, GTK_ICON_SIZE_DIALOG);
  ...
  gtk_table_attach(GTK_TABLE(table), window_hospital.label_cash, 1, 2, 0, 1,
                    static_cast<GtkAttachOptions>(0), static_cast<GtkAttachOptions>(0), 0, 0);
...
GtkWidget* create_places_menu() {
  ...
  GtkWidget *menuitem = gtk_menu_item_new_with_label("Finances...");
  gtk_menu_shell_append(GTK_MENU_SHELL(menu), menuitem);
  g_signal_connect(menuitem, "activate",
                   G_CALLBACK(menuitem_places_finances_activate_cb), nullptr);
  gtk_widget_show(menuitem);

  menuitem = gtk_menu_item_new_with_label("Shopping...");
  gtk_menu_shell_append(GTK_MENU_SHELL(menu), menuitem);
  g_signal_connect(menuitem, "activate",
                   G_CALLBACK(menuitem_places_shopping_activate_cb), nullptr);
  gtk_widget_show(menuitem);

  menuitem = gtk_menu_item_new_with_label("Hospital...");
  gtk_menu_shell_append(GTK_MENU_SHELL(menu), menuitem);
  g_signal_connect(menuitem, "activate",
                   G_CALLBACK(menuitem_places_hospital_activate_cb), nullptr);
  gtk_widget_show(menuitem);

  menuitem = gtk_menu_item_new_with_label("Vault...");
  gtk_menu_shell_append(GTK_MENU_SHELL(menu), menuitem);
  g_signal_connect(menuitem, "activate",
                   G_CALLBACK(menuitem_places_vault_activate_cb), nullptr);
  gtk_widget_show(menuitem);

  menuitem = gtk_menu_item_new_with_label("Shipping...");
  gtk_menu_shell_append(GTK_MENU_SHELL(menu), menuitem);
  g_signal_connect(menuitem, "activate",
                   G_CALLBACK(menuitem_places_shipping_activate_cb), nullptr);
  gtk_widget_show(menuitem);
...
GtkWidget* create_info_menu() {
  ...
  GtkWidget *menuitem = gtk_menu_item_new_with_label("Vaults...");
  gtk_menu_shell_append(GTK_MENU_SHELL(menu), menuitem);
  g_signal_connect(menuitem, "activate",
                   G_CALLBACK(menuitem_info_vaults_activate_cb), nullptr);
  gtk_widget_show(menuitem);

  menuitem = gtk_menu_item_new_with_label("World Drug Prices...");
  gtk_menu_shell_append(GTK_MENU_SHELL(menu), menuitem);
  g_signal_connect(menuitem, "activate",
                   G_CALLBACK(menuitem_info_drug_prices_activate_cb), nullptr);
  gtk_widget_show(menuitem);

  menuitem = gtk_menu_item_new_with_label("World Cities...");
  gtk_menu_shell_append(GTK_MENU_SHELL(menu), menuitem);
  g_signal_connect(menuitem, "activate",
                   G_CALLBACK(menuitem_info_world_cities_activate_cb), nullptr);
  gtk_widget_show(menuitem);

  menuitem = gtk_menu_item_new_with_label("Shipment Status...");
  gtk_menu_shell_append(GTK_MENU_SHELL(menu), menuitem);
  g_signal_connect(menuitem, "activate",
                   G_CALLBACK(menuitem_info_shipment_status_activate_cb), nullptr);
  gtk_widget_show(menuitem);

  menuitem = gtk_menu_item_new_with_label("History...");
  gtk_menu_shell_append(GTK_MENU_SHELL(menu), menuitem);
  g_signal_connect(menuitem, "activate",
                   G_CALLBACK(menuitem_info_history_activate_cb), nullptr);
  gtk_widget_show(menuitem);
